...
if has('nvim')
	...
	hi StatusLineTermNC ctermbg=239  ctermfg=235 guibg=#1C1F20 guifg=#7C7F88 cterm=italic gui=italic
else
	...
	hi StatusLineTermNC ctermbg=239  ctermfg=235 guibg=#1C1F20 guifg=#7C7F88 cterm=NONE gui=NONE
endif
...
hi Visual         ctermbg=8    ctermfg=NONE guibg=#404040 guifg=NONE    cterm=NONE           gui=NONE
